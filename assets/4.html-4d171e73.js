import{_ as l,p as d,q as r,s as n,R as e,t as i,Z as a,n as t}from"./framework-87c4c4c1.js";const c="/assets/1-ba1ff9a2.png",v="/assets/2-4b71efbf.png",o="/assets/3-4ad4a04a.png",m="/assets/4-f1f0e34d.png",p="/assets/5-6925189b.png",u="/assets/6-d2e0f10e.png",b="/assets/7-e9cd2b54.png",g="/assets/8-8e9a29ff.png",h="/assets/9-348824bf.png",x="/assets/10-64f6e845.png",_="/assets/11-99acb044.png",f="/assets/12-d75a2c71.png",k="/assets/14-feb531b8.png",j="/assets/13-1948d395.png",w="/assets/15-ab733fe0.png",y="/assets/16-ce8d064e.png",A="/assets/17-d81d8e6f.png",N="/assets/18-0c6e982d.png",$={},q=n("h2",{id:"简介",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#简介","aria-hidden":"true"},"#"),e(" 简介")],-1),z=n("p",null,[n("img",{src:c,alt:"Alt text"})],-1),I={href:"http://nginx.org/",target:"_blank",rel:"noopener noreferrer"},P=a(`<h2 id="安装" tabindex="-1"><a class="header-anchor" href="#安装" aria-hidden="true">#</a> 安装</h2><h3 id="安装-openssl-、zlib-、-gcc-依赖" tabindex="-1"><a class="header-anchor" href="#安装-openssl-、zlib-、-gcc-依赖" aria-hidden="true">#</a> 安装 openssl 、zlib 、 gcc 依赖</h3><div class="language-json line-numbers-mode" data-ext="json"><pre class="language-json"><code>yum -y install make zlib zlib-devel gcc-c++ libtool openssl openssl-devel
...
<span class="token number">3</span>.在 windows 系统中通过浏览器访问 tomcat 服务器
    ...
    <span class="token punctuation">}</span>
        ...
        location /image/ <span class="token punctuation">{</span>
           ...
           autoindex on;
        <span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><img src="`+y+'" alt="Alt text"></p><p><img src="'+A+'" alt="Alt text"></p><p><img src="'+N+'" alt="Alt text"></p><h2 id="高可用" tabindex="-1"><a class="header-anchor" href="#高可用" aria-hidden="true">#</a> 高可用</h2>',35);function H(S,T){const s=t("ExternalLinkIcon");return d(),r("div",null,[q,z,n("p",null,[n("a",I,[e("官网"),i(s)])]),P,n("p",null,[e("1、实现效果 打开浏览器，在浏览器地址栏输入地址ip，跳转到 liunx 系统 "),n("a",E,[e("tomcat"),i(s)]),e(" 主页面中")]),L])}const V=l($,[["render",H],["__file","4.html.vue"]]);export{V as default};
